This has been designed to go through Invoicely invoices and extract the total from each onvoice, save them in a text file in the directory and then provide s um total of all invoices.
